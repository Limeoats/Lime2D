...
// ADD - Lime2D theme
void ImGui::StyleColorsLime2D(ImGuiStyle* dst) {
    ...
    colors[ImGuiCol_Text]                   = ImVec4(0.90f, 0.90f, 0.90f, 1.00f);
    colors[ImGuiCol_TextDisabled]           = ImVec4(0.60f, 0.60f, 0.60f, 1.00f);
    colors[ImGuiCol_WindowBg]               = ImVec4(0.02f, 0.07f, 0.02f, 0.90f); //Green
    colors[ImGuiCol_ChildWindowBg]          = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_PopupBg]                = ImVec4(0.05f, 0.15f, 0.05f, 0.90f); //Green
    colors[ImGuiCol_Border]                 = ImVec4(0.70f, 0.70f, 0.70f, 0.65f);
    colors[ImGuiCol_BorderShadow]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_FrameBg]                = ImVec4(0.80f, 0.80f, 0.80f, 0.30f);   // Background of checkbox, radio button, plot, slider, text input
    colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.90f, 0.80f, 0.80f, 0.40f);
    colors[ImGuiCol_FrameBgActive]          = ImVec4(0.90f, 0.65f, 0.65f, 0.45f);
    colors[ImGuiCol_TitleBg]                = ImVec4(0.10f, 0.50f, 0.10f, 0.80f); //Green
    ...
    colors[ImGuiCol_Button]                 = ImVec4(0.30f, 0.60, 0.30f, 0.60f);  //Green
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.30f, 0.60, 0.30f, 1.00f);  //Green
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.40f, 0.70f, 0.40f, 1.00f); //Green
    colors[ImGuiCol_Header]                 = ImVec4(0.20f, 0.80f, 0.20f, 0.45f); //Green
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.20f, 0.70f, 0.20f, 0.80f); //Green
    colors[ImGuiCol_HeaderActive]           = ImVec4(0.23f, 0.67f, 0.23f, 0.80f); //Green
